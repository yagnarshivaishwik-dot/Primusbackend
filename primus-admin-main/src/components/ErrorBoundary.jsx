 ...
 * whole admin shell. Reports the crash to /api/audit/ui-crash so we can
 * surface UI regressions in the audit log.
 */
    ...
    try {
      ...
      if (typeof fetch === 'function') {
        fetch('/api/audit/ui-crash', {
          ...
          /* allowed to fail; console log is the floor */
        });
      }
    } catch {
    ...
    if (this.state.hasError) {
      return (
        ...
        >
          ...
          <p>The rest of the admin app is still running. You can retry this view.</p>
