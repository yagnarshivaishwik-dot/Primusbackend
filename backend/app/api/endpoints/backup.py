...
def create_backup_unavailable():
    """
    Legacy SQLite file-based backups have been replaced by infrastructure-managed
    PostgreSQL backups (e.g., WAL-G/S3 snapshots).

    This endpoint is intentionally disabled to avoid confusion; operators should
    use the documented backup pipeline instead.
    """
    raise HTTPException(
        status_code=501,
