...
// Social-login (Google + Apple) is intentionally hidden right now.
// We haven't obtained the production OAuth credentials / app-store
// review for these providers yet, so the buttons would either silently
// fail or hit a redirect that customers can't complete. Flip back to
// `true` once the OAuth client IDs + Apple Developer review are in
// place. Keeping the UI markup below conditional rather than deleting
// it makes the re-enable a one-character change.
