            ...
            <div className="header__actions">
                ...
                <div className={`dropdown ${dropdownOpen ? 'open' : ''}`}>
                    ...
                    >
                        ...
                        <div className="header__user-avatar">{user.initials}</div>
                        ...
                        <div className="dropdown__section">
                            <div className="balance-cards" style={{ gridTemplateColumns: 'repeat(3, 1fr)' }}>
                                <div className="balance-card">
                                    ...
                                    <div className="balance-card__value" style={{ fontSize: '0.9375rem' }}>{user.cashBalance}</div>
                                    <div className="balance-card__label">Cash</div>
                                </div>
                                <div className="balance-card">
                                    <Clock size={18} style={{ color: 'var(--accent-primary)', marginBottom: '4px' }} />
                                    <div className="balance-card__value" style={{ fontSize: '0.9375rem', color: 'var(--accent-primary)' }}>{user.timeRemaining}</div>
                                    <div className="balance-card__label">Time</div>
                                </div>
                                <div className="balance-card">
                                    <Coins size={18} style={{ color: 'var(--warning)', marginBottom: '4px' }} />
                                    <div className="balance-card__value" style={{ fontSize: '0.9375rem', color: 'var(--warning)' }}>{user.ggCoins}</div>
